...
urlpatterns = [
    path('onec_ttn/detailed/<int:pk>/', OfflineOneCTTNRetrieveAPIView.as_view()),
    path('onec_ttn/list/', OfflineOneCTTNListAPIView.as_view()),
    path('onec_ttn_item/', OfflineOneCTTNItemListView.as_view()),
