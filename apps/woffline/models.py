...
class OfflineNotPackaging(models.Model):
    product = models.ForeignKey(OfflineProducts, on_delete=models.CASCADE, db_constraint=False)
    warehouse = models.ForeignKey(OfflineWarehouse, on_delete=models.CASCADE)
    bloom_user = models.ForeignKey(OfflineUser, on_delete=models.CASCADE)
