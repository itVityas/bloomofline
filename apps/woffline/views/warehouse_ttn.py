...
@extend_schema_view(
    get=extend_schema(
        summary='Get list all only OfflineWarehouseTTN with filters',
        description='Permission: admin, warehouse, warehouse_writer',
    ),
)
class OnlyOfflineWarehouseTTNListAPIView(ListAPIView):
    queryset = OfflineWarehouseTTN.objects.all()
    serializer_class = OfflineWarehouseTTNGetSerializer
    permission_classes = [IsAuthenticated, WarehousePermission]
    pagination_class = StandartResultPaginator
...
@extend_schema_view(
    get=extend_schema(
        summary='Get a WarehouseTTN, only Offline',
        description='Permission: admin, warehouse, warehouse_writer',
    ),
    put=extend_schema(
        summary='Update a WarehouseTTN, only Offline',
        description='Permission: admin warehouse_writer',
    ),
    patch=extend_schema(
        summary='Partial update a WarehouseTTN, only Offline',
        description='Permission: admin warehouse_writer',
    ),
    delete=extend_schema(
        summary='Delete a WarehouseTTN, only Offline',
        description='Permission: admin, warehouse_writer',
    )
)
class OnlyOfflineWarehouseTTNRetrieveUpdateDestroyAPIView(RetrieveUpdateDestroyAPIView):
    queryset = OfflineWarehouseTTN.objects.all()
    serializer_class = OfflineWarehouseTTNPostSerializer
    permission_classes = [IsAuthenticated, WarehousePermission]
...
@extend_schema_view(
    get=extend_schema(
        summary='Get WarehouseTTN products by onecttn number and series',
        description='Permission: admin, warehouse, warehouse_writer',
        parameters=[
            OpenApiParameter(
                name='number',
...
class OfflineWarehouseTTNByOneCProductsAPIView(APIView):
    permission_classes = [IsAuthenticated, WarehousePermission]
    serializer_class = OfflineWarehouseTTNProductSerializer
    queryset = OfflineWarehouseTTN.objects.all()
